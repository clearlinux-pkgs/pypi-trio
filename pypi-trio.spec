...
Source0  : https://files.pythonhosted.org/packages/73/66/bc155385503674288a440384c1c262c755af4c218e56e61e4b90635b15af/trio-0.26.0.tar.gz
...
%prep
%setup -q -n trio-0.26.0
cd %{_builddir}/trio-0.26.0
pushd ..
cp -a trio-0.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720197431
