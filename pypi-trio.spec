...
Source0  : https://files.pythonhosted.org/packages/17/d1/a83dee5be404da7afe5a71783a33b8907bacb935a6dc8c69ab785e4a3eed/trio-0.27.0.tar.gz
...
%prep
%setup -q -n trio-0.27.0
cd %{_builddir}/trio-0.27.0
pushd ..
cp -a trio-0.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729177155
