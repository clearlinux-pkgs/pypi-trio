...
Source0  : https://files.pythonhosted.org/packages/b9/37/74d6556dda898c0dec707a5877c3d7a12a294682151616cee58643accd17/trio-0.25.1.tar.gz
...
%prep
%setup -q -n trio-0.25.1
cd %{_builddir}/trio-0.25.1
pushd ..
cp -a trio-0.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715874434
