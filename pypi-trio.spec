...
Source0  : https://files.pythonhosted.org/packages/01/c1/68d582b4d3a1c1f8118e18042464bb12a7c1b75d64d75111b297687041e3/trio-0.30.0.tar.gz
...
%prep
%setup -q -n trio-0.30.0
cd %{_builddir}/trio-0.30.0
pushd ..
cp -a trio-0.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745243611
