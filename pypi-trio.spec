...
Source0  : https://files.pythonhosted.org/packages/a1/47/f62e62a1a6f37909aed0bf8f5d5411e06fa03846cfcb64540cd1180ccc9f/trio-0.29.0.tar.gz
...
%prep
%setup -q -n trio-0.29.0
cd %{_builddir}/trio-0.29.0
pushd ..
cp -a trio-0.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739545792
